package com.shekhar.myapplication;
...
public class PoastAdapter extends RecyclerView.Adapter<PoastAdapter.PostViewHolder> {

    List<Post> postList;
    Context context;

    public PoastAdapter(Context context , List<Post> posts){
